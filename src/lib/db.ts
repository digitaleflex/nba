...
function createPrismaClient() {
  ...
  // NOTE: $use is deprecated in Prisma 7.x. Retry is handled via withRetryTransaction()
  // for explicit transactions, and the pg Pool handles connection-level retry.
